module Etl
  module Runners
    class NycPermittedEventInformationSoda3IntoPrimaryDb
      def self.run
        job = Etl::WorkflowTemplates::Soda3IntoPrimaryDb.setup({
          source_config: {
            remote_url: ::OfficeOfCitywideEventCoordinationAndManagement::NycPermittedEventInformation::SODA3_API_ENDPOINT
          },
          transform_config: {
